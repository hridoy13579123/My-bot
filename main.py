    ...
    def buy(self , exchange , asset1 , asset2 , amount_percentage=None , amount=None , limit=None , timeout=None):
        try:
            ...
            if not limit:
                ...
                if DRY_RUN:
                    self.log("[DRY RUN] Skipping market buy order for {}/{}.".format(asset1 , asset2))
                    return True
                ...
                if DRY_RUN:
                    self.log("[DRY RUN] Skipping limit buy order for {}/{} @{}.".format(asset1 , asset2 , limit))
                    return True
    ...
    def sell(self , exchange , asset1 , asset2 , amount_percentage=None , amount=None , limit=None , timeout=None):
        try:
            ...
            if not limit:
                ...
                if DRY_RUN:
                    self.log("[DRY RUN] Skipping market sell order for {}/{}.".format(asset1 , asset2))
                    return True
                ...
                if DRY_RUN:
                    self.log("[DRY RUN] Skipping limit sell order for {}/{} @{}.".format(asset1 , asset2 , limit))
                    return True
